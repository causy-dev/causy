...
class IndependenceTestTestCase(unittest.TestCase):
    def test_correlation_coefficient_standard_model(self):
        ...
        self.assertEqual(tst(x, y, UndirectedGraph()), False)
    ...
    def test_correlation_of_noise(self):
        ...
        self.assertEqual(tst([x, y], UndirectedGraph()), True)
    ...
    def test_extended_partial_correlation_test(self):
        ...
        y = sum_lists(
            [3 * z1_val for z1_val in z1],
            [3 * z2_val for z2_val in z2],
            [3 * z3_val for z3_val in z3],
            noise_y,
        )
        self.assertEqual(tst([x, y, z1, z2, z3], UndirectedGraph()), True)
