...
class GraphTestCase(CausyTestCase):
    ...
    def test_directed_paths_example(self):
        graph = GraphManager()
        node1 = graph.add_node("test1", [1, 2, 3])
        node2 = graph.add_node("test2", [1, 2, 3])
        node3 = graph.add_node("test3", [1, 2, 3])
    ...
    def test_paths_for_inducing_paths_example(self):
        graph = GraphManager()
        node1 = graph.add_node("test1", [1, 2, 3])
        node2 = graph.add_node("test2", [1, 2, 3])
        node3 = graph.add_node("test3", [1, 2, 3])
    ...
    def test_inducing_path_exists(self):
        ...
        graph.add_bidirected_edge(node1, node2, {"test": "test"})
        graph.add_directed_edge(node3, node2, {"test": "test"})
        self.assertFalse(graph.inducing_path_exists(node1, node2))
        self.assertTrue(graph.inducing_path_exists(node2, node3))
    ...
    def test_inducing_path_exists_3(self):
        ...
        self.assertFalse(graph.inducing_path_exists(node2, node4))
        # There is a direct edge from node3 to node1
    ...
    def test_path_exists_directed_case(self):
        ...
        graph.add_directed_edge(node1, node2, {"test": "test"})
        graph.add_directed_edge(node2, node3, {"test": "test"})
        self.assertTrue(graph.path_exists(node1, node2))
        self.assertTrue(graph.path_exists(node2, node1))
        self.assertTrue(graph.path_exists(node2, node3))
        self.assertTrue(graph.path_exists(node3, node2))
        self.assertTrue(graph.path_exists(node1, node3))
        self.assertTrue(graph.path_exists(node3, node1))

    def test_path_exists_bidirected_case(self):
        graph = GraphManager()
        node1 = graph.add_node("test1", [1, 2, 3])
        node2 = graph.add_node("test2", [1, 2, 3])
        graph.add_bidirected_edge(node1, node2, {"test": "test"})
    ...
    def test_path_exists_collider_case(self):
        graph = GraphManager()
        node1 = graph.add_node("test1", [1, 2, 3])
        node2 = graph.add_node("test2", [1, 2, 3])
        node3 = graph.add_node("test3", [1, 2, 3])
        graph.add_directed_edge(node1, node2, {"test": "test"})
        graph.add_directed_edge(node3, node2, {"test": "test"})
        self.assertFalse(graph.path_exists(node1, node3))
        self.assertFalse(graph.path_exists(node3, node1))
