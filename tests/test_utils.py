...
from utils import backward_substituion, get_regression_coefficients, get_residuals, extended_partial_correlation_2_test
...
class UtilsTestCase(unittest.TestCase):
    ...
    def test_backward_substitution(self):
        ...
        b = Matrix([6, 15, 24])
        n = 2
        self.assertEqual(backward_substituion(R, b, n), Matrix([[-7 / 2], [-5 / 4], [4]]))
